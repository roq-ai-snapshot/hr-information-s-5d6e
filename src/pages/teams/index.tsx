...
export function TeamListPage(props: TeamListPageProps) {
  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['user', 'employee.count', 'team_user.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('employee', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('team_user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'team_user',
          header: 'Team User',
          accessorKey: 'team_user',
          cell: ({ row: { original: record } }: any) => record?._count?.team_user,
        }
      : null,
