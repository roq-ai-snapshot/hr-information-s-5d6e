...
import { useTeamUserFindFirst, useRoqClient } from 'lib/roq';
...
function TeamUserViewPage() {
  ...
  const { data, error, isLoading } = useTeamUserFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('team_user', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/team-users/edit/${id}`} passHref legacyBehavior>
                    <Button
