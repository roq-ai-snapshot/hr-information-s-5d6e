...
import { usePayrollCount, useEmployeeCount, useTeamUserCount, useRoqPlatformUserProfiles } from 'lib/roq';
...
function DashboardPage() {
  ...
  const teamUserStat = useTeamUserCount();
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    ...
    {
      title: 'Team Users',
      result: teamUserStat?.data,
      isLoading: teamUserStat.isLoading,
      change: Math.floor(Math.random() * (100 - 40 + 1) + 40),
    },
