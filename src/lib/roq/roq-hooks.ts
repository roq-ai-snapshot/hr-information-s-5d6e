...
export function useTeamUserFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useTeamUserFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.team_user.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useTeamUserCount<T extends Prisma.team_userCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.team_userCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useTeamUserCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.team_user.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useTeamUserFindManyWithCount<
  T extends Prisma.team_userFindManyArgs,
  R extends { data: GetFindResult<Prisma.$team_userPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.team_userFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useTeamUserFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.team_user.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useTeamUserFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useTeamUserFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.team_user.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
